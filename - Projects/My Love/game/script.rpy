...
label chapter_0_journal_1:
    ...
    nvl clear
    play sound "sfx/thud_1.mp3"
    "It's usually never this noisy this early in the morning, especially since the unit next to me is empty. What's all the noise about?"
...
label chapter_0_meet_claudia:
    ...
    "It's good to know she's interested in seeing me again, at least."
...
label chapter_0_journal_2:
    ...
    "Maybe if I spend a couple of minutes doing it now, no one will notice?"
...
label chapter_0_driving_home:
    ...
    alex "That, and you know someone hasn't through up where you're sitting?"
    tsukune "Wait, huh?"
