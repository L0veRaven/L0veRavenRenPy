...
define config.after_load_transition = fade # default = None


## Used when entering the main menu after the game has ended.

define config.end_game_transition = fade # default = None
