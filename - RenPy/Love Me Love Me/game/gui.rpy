...
define gui.accent_color = '#595959'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#4c4c4c'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#797979'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#4879b9'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#a0a0a0'
...
define gui.muted_color = '#004851'
define gui.hover_muted_color = '#013050'
...
define gui.quick_button_borders = Borders(100, 5, 15, 2.5)
...
define gui.nvl_borders = Borders(25, 150, 25, 150)

## The maximum number of NVL-mode entries Ren'Py will display. When more entries than this are to be shown, the oldest entry will be removed.
